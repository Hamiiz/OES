    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deff', models.CharField(choices=[('e', 'easy'), ('m', 'medium'), ('h', 'hard')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_type', models.CharField(choices=[('MC', 'multiple choice'), ('TF', 'True/False'), ('SA', 'Short answer')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answer', to='exams.question')),
            ],
        ),
        migrations.CreateModel(
            name='Submition',
